...
<div class="w-100 bg-light" style="margin-top: 80px;height: 100px;text-align: center;padding-top: 25px;">
    <div class="container">
        ...
        $res = mysqli_query($link, "SELECT * FROM category_lesson WHERE id_categorylesson = '" . $id . "'");
        while ($row = mysqli_fetch_array($res)) {
        ?>
            <h2 class="text-dark text-uppercase"><?php echo $row['name_categorylesson'] ?></h2>
...
<div class="album py-5">
    <div class="container">
        <div class="row">
            <?php
            $res = mysqli_query($link, "SELECT * FROM detailcategory_lesson WHERE id_categorylesson = '" . $id . "'");
            while ($row = mysqli_fetch_array($res)) {
